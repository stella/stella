...
import {
  formatFullTimestamp,
  formatFullTimestamp as fullTimestamp,
  formatRelativeTime,
...
// Aliasing the canonical import must not bypass the native-title ban.
// oxlint-disable-next-line require-relative-time-helpers/require-relative-time-helpers
const _aliasedTitle = <span title={fullTimestamp(date)}>time</span>;
