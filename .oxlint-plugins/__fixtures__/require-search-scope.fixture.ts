...
declare const entityWorkspaceFilter: unknown;
declare const singleWorkspaceFilter: unknown;
declare const workspaceAccessSql: (scope: unknown) => unknown;
declare const contactWorkspaceAccessSql: (scope: unknown) => unknown;
declare const chatThreadScopeSql: (scope: unknown) => unknown;
