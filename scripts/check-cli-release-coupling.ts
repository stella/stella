...
/** The source paths whose generated bytes are part of the CLI/API contract. */
export const CLI_CONTRACT_SURFACE_PATHS = SURFACE_PARTS;
...
export const canonicalSurfacePart = (
