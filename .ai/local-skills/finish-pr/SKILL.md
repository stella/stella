---
name: finish-pr
description: 'Drive an existing PR through rebase, independent review, CI, and repeated bot-review rounds until it is clean or genuinely blocked; merge only when explicitly requested.'
---
