...
| `style-sets.style-catalogue.get` | read               | stella:templates | —       | generic invoke → `stella capability style-sets style-catalogue-get`                                                                                                                                                                                              |
| `style-sets.style-guide.update`  | write              | stella:templates | —       | generic invoke → `stella capability style-sets style-guide-update`                                                                                                                                                                                               |
