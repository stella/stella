...
Beyond the curated commands above, the CLI generates 265
...
| template     | `stella template save-filled new-document` | documents_write |                                       |
| template     | `stella template save-filled new-version`  | documents_write |                                       |
