// Canonical ISO 3166-1 alpha-2 country code list used across the stella
// monorepo. Frozen as a readonly tuple so `(typeof COUNTRY_CODES)[number]`
// resolves to a literal-string union, not just `string`.
//
...
export const isCountryCode = (value: unknown): value is CountryCode =>
  typeof value === "string" && COUNTRY_CODE_SET.has(value);
