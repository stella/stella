...
import { Input, type InputProps } from "@stella/ui/components/input";
import { Textarea, type TextareaProps } from "@stella/ui/components/textarea";
import { cn } from "@stella/ui/lib/utils";

function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: coss ui
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: coss ui
    // biome-ignore lint/a11y/noStaticElementInteractions: coss ui
    <div
