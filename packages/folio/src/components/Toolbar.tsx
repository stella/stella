...
export function Toolbar({
  ...
  return (
    <div
      ref={toolbarRef}
      className={cn(
        "flex h-10 items-center justify-center overflow-x-auto border-b border-[var(--doc-border)] bg-[var(--doc-page)] px-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",
        className,
      )}
      style={style}
      role="toolbar"
