...
export const INFO_SOUD_CODE_CATALOG_SOURCE_PAGE_URL =
  "https://infosoud.gov.cz/";
export const INFO_SOUD_CODE_CATALOG_SOURCE_BUNDLE_URL =
  "https://infosoud.gov.cz/chunk-ZMUSO5Q7.js";
...
export const INFO_SOUD_EVENT_LABELS = {
  ...
  PNS_ODLOZ:
    "Poznámka o procesních opatřeních - Usnesení o odložení vykonavatelnosti",
...
export const INFO_SOUD_EVENT_TOOLTIPS = {
  DOVOL_RIZ:
    "<b>Řízení o opravném prostředku na Nejvyšším soudu ČR</b> se myslí zahájení dovolacího řízení na Nejvyšším soudu",
  NAD_RIZENI:
    "<b>Řízení u nadřízeného soudu</b> se myslí zahájení souvisejícího řízení na nadřízeném soudu",
  NAR_JED:
    "<b>Nařízení jednání</b> je naplánování jednání do jednacího kalendáře soudu",
  ODES_SPIS:
    "<b>Odesláním spisu</b> se rozumí: např.: odeslání nadřízenému soudu k prostudování",
  ODVOLANI:
    "<b>Řízení o opraveném prostředku u krajského a vrchního soudu</b> se myslí zahájení odvolacího řízení",
  PNS_NASTUP:
    "Druhem rozhodnutí ve věci bylo rozhodnutí o procesním nástupnictvím",
  PNS_ODL_PM: "<b>Poznámka o procesních opatřeních - Odložení právní moci</b>",
  PNS_ODLOZ:
    "Druhem rozhodnutí ve věci bylo usnesení o odložení vykonavatelnosti",
  PNS_VYZVA: "Druhem rozhodnutí ve věci byla Výzva",
  POD_OP_PR:
    "<b>Podání opravného prostředku</b> je např. odvolání některého z účastníků řízení k vydanému rozhodnutí ve věci",
  PR_VEC_NS: "Datum kdy bylo přerušeno soudní řízení",
  PREVD_SPIS:
    "Událostí <b>Převedeno</b> se rozumí: ukončení zpracování věci a převedení dalšího řízení pod jinou spisovou značku",
  SPIS_K_SC: "<b>Odesláním spisu</b> se rozumí odeslání spisu soudci",
  SPIS_K_SO:
    "<b>Odesláním spisu</b> se rozumí odeslání spisu soudnímu komisaři",
  SPIS_OD_SC: "<b>Předáním spisu soudcem</b> se rozumí vrácení spisu od soudce",
  SPIS_OD_SO:
    "<b>Předáním spisu soudním komisařem</b> se rozumí vrácení spisu od soudního komisaře",
  ST_VEC_OBZ:
    "<b>Obživnutím věci</b> se myslí zrušení původního vyřizujícího rozhodnutí a v soudním řízení se pokračuje",
  ST_VEC_ODS:
    'Tzv. <b>"Odškrtnutí"</b> věci, nastane v okamžiku vyřízení všech náležitostí souvisejících s řízením',
  ST_VEC_PRE:
    "<b>Přerušením řízení věci</b> nastává např.: v případě prohlášení konkurzu na účastníka řízení",
  ST_VEC_PUK: "Datum pravomocného ukončení věci",
  ST_VEC_UPR: "Ukončeno přerušení řízení",
  ST_VEC_VYR: "<b>Vyřízením věci</b> se myslí vyřízení věci",
  VR_SP_NS:
    "<b>Datem vrácení spisu</b> se myslí vrácení spisu odvolacímu soudu",
  VRAC_SPIS:
    "<b>Vrácením spisu</b> se rozumí: např.: na vrácení spisu od nadřízeného soudu",
  VYD_ROZH:
    "<b>Vydání rozhodnutí</b> je rozhodnutí soudce nebo vyšší soudní úřednice",
  VYR_OP_PR:
    "<b>Opravný prostředek</b> je vyřízen např. nadřízeným krajským soudem, kde je vydáno nové rozhodnutí",
  ZAHAJ_RIZ:
    "<b>Zahájení řízení</b> je zápis spisové značky do příslušného rejstříku",
...
export const INFO_SOUD_EVENT_TOOLTIP_OVERRIDES = {
  ns: {
    NAR_JED:
      "<b>Nařízení jednání</b> je naplánování jednání do jednacího kalendáře soudu",
    ODES_SPIS:
      "<b>Spisem SO</b> se myslí odeslání spisu znalci nebo jiným státním orgánům",
    PNS_NASTUP:
      "Druhem rozhodnutí ve věci bylo rozhodnutí o procesním nástupnictvím",
    PNS_ODL_PM:
      "<b>Poznámka o procesních opatřeních - Odložení právní moci</b>",
    PNS_ODLOZ:
      "Druhem rozhodnutí ve věci bylo usnesení o odložení vykonavatelnosti",
    PNS_VYZVA: "Druhem rozhodnutí ve věci byla Výzva",
    PR_VEC_NS: "Datum kdy bylo přerušeno soudní řízení",
...
export const INFO_SOUD_EVENT_DESCRIPTIONS = {
  ...
  ST_VEC_ODS:
    "Skončení věci a uložení na spisovnu nebo převedení pod jinou spisovou značku",
  ST_VEC_PRE: "Bylo přerušeno soudní řízení",
  ST_VEC_PUK: "Datum pravomocného ukončení věci",
  ST_VEC_UPR:
    "Bylo ukončeno přerušení věci a bude pokračováno v soudním řízení",
