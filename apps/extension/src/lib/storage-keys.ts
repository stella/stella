export const BROWSER_CONTROLLER_STORAGE_KEY = "browserController";
export const BROWSER_CONTROLLED_TAB_STORAGE_KEY = "browserControlledTab";
export const BROWSER_EXECUTION_RECEIPTS_STORAGE_KEY =
