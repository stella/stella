...
describe("justifications", () => {
  ...
  test("extractJustificationContent treats pre-kind blocks as pdf-bates", () => {
    ...
    // oxlint-disable-next-line typescript-eslint/no-unsafe-type-assertion -- test injects a legacy shape the typed surface can't express; that tolerance is the SUT
