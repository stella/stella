...
// physical mutations its lifecycle requires. The lint rule consumes this map,
// verifies every grant is exercised, and rejects the same mutations elsewhere.
