...
/**
 * Close the removed member's single active timer while the offboarding
 * transaction owns the user/workspace locks, then revoke auth artifacts.
 */
export const revokeRemovedMemberAccess = async ({
  organizationId,
  userId,
}: {
