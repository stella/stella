...
export const legalReaderAnnotations = p.pgTable(
  ...
  (t) => [
    p
      .foreignKey({
        name: "legal_reader_annotations_organization_id_fk",
    ...
    p
      .foreignKey({
        name: "legal_reader_annotations_user_id_fk",
        columns: [t.userId],
    ...
    p.check(
      "legal_reader_annotations_kind_shape",
    ...
    p.check(
      "legal_reader_annotations_span_shape",
