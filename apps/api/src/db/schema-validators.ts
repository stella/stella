...
export type ViewLayout = Static<typeof viewLayoutSchema>;

export const viewFilterConditionSchema = t.Union([
  t.Object({
    field: t.Literal("kind"),
    op: t.Literal("eq"),
    value: entityKindSchema,
  }),
  t.Object({
    field: t.Literal("kind"),
    op: t.Literal("in"),
...
export type ViewFilterCondition = Static<typeof viewFilterConditionSchema>;

export const kanbanConfigSchema = t.Object({
...
export const viewConfigSchema = t.Object({
  ...
  visibleProperties: t.Array(t.String()),
