export const CHATGPT_APP_SUBMISSION_PROFILE = {
  ...
  test_cases: [
    ...
    {
      description: "Research case law through the compatibility search tool.",
      user_prompt:
        "Using stella, find Czech case law on the limitation period for a damages claim.",
      file_attachment_urls: null,
      tools_triggered: "search",
      expected_output:
        "Returns case-law results from the public legal corpus, each with an id, a court and docket title, and a url, without exposing matter data.",
      expected_output_url: null,
    },
    {
