...
ALTER TABLE "agent_skill_proposals" ADD CONSTRAINT "agent_skill_proposals_base_revision_id_agent_skill_revisions_id_fk" FOREIGN KEY ("base_revision_id") REFERENCES "public"."agent_skill_revisions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "agent_skill_proposals" ADD CONSTRAINT "agent_skill_proposals_result_revision_id_agent_skill_revisions_id_fk" FOREIGN KEY ("result_revision_id") REFERENCES "public"."agent_skill_revisions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
