...
--> statement-breakpoint
CREATE INDEX CONCURRENTLY IF NOT EXISTS "chat_thread_compactions_memory_unmined_idx" ON "chat_thread_compactions" ("memory_extraction_attempted_at" ASC NULLS FIRST, "created_at", "id") WHERE memory_extracted_at IS NULL AND status = 'active';
--> statement-breakpoint
