...
export const COMPARE_CHANGE_KIND_LABEL_KEYS = {
  ...
  "run-format": "folio.textFormattingGroup",
  "inline-atom": "fileDetail.compareChangeKinds.inlineObjects",
  "section-properties": "fileDetail.compareChangeKinds.sectionProperties",
