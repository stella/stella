...
// other's gradients. The parts below are shared by both marks; each mark keeps
// its own paint order.
...
const OpenDocumentArrows = ({ fill }: { fill: string }) => (
  <g>
    <path
      fill={fill}
...
const OpenDocumentSheen = ({ uid }: { uid: string }) => (
  <>
    <linearGradient
      id={`${uid}-1`}
...
const OpenDocumentBadgeHighlight = ({ id }: { id: string }) => (
  <>
    <linearGradient
      id={id}
      gradientUnits="userSpaceOnUse"
    ...
    <polygon fill={`url(#${id})`} points="24,14 4,17 4,37 24,40" />
  </>
);

const OpenDocumentBadgeShadow = ({ id }: { id: string }) => (
  <>
    <linearGradient
      id={id}
      gradientUnits="userSpaceOnUse"
    ...
    <polygon fill={`url(#${id})`} points="24,43 12,43 12,38.2 24,40" />
  </>
);
...
export const OdtIcon = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <OpenDocumentArrows fill="#ACBBE3" />
      <OpenDocumentSheen uid={uid} />
      <OpenDocumentBadgeHighlight id={`${uid}-4`} />
      <OpenDocumentBadgeShadow id={`${uid}-5`} />
      <OpenDocumentBadgeHighlight id={`${uid}-6`} />
    </svg>
  );
};
...
export const OdsIcon = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <OpenDocumentArrows fill="#8BBF8A" />
      <OpenDocumentSheen uid={uid} />
      <OpenDocumentBadgeShadow id={`${uid}-4`} />
      <OpenDocumentBadgeHighlight id={`${uid}-5`} />
    </svg>
  );
};
