...
export const ChatMentionList = ({
  ...
  if (latestClientRect) {
    // oxlint-disable-next-line react/refs -- retains the last non-null caret rect so the Floating UI anchor keeps its position when clientRect() momentarily returns null
  ...
  // oxlint-disable-next-line react/refs -- reads the retained last-known caret rect (written above from this render's clientRect) to gate the positioner; the ref persists the value across renders where clientRect() returns null
