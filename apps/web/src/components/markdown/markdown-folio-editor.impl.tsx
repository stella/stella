...
export const MarkdownFolioEditor = ({
  ...
  // side margins off the right edge, whereas fitting the page (DOCX_PAGE_FIT_WIDTH
  // bakes in a gutter allowance) centres it with breathing space on each side and
  // re-fits on resize. composeRefs merges the wheel-zoom container ref with the fit
  // hook's callback ref onto one element.
