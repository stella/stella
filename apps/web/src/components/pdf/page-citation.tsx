...
export const PageCitation = ({
  ...
  if (scrollTo === null) {
    // eslint-disable-next-line react/refs -- reset gated on scrollTo consumption; scrolledRef is read/written only in the commit-phase ref callback below, never for rendered output
