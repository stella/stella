...
export const usePDFDocument = ({ key, context }: PDFDocumentOptionsInput) => {
  ...
  // oxlint-disable-next-line @tanstack/query/exhaustive-deps -- this hook intentionally keys by file identity and uses manual query removal when the in-memory buffer or password changes.
