...
type Messages = {
  ...
  "caseLaw": {
    ...
    "chat": {
      "prompts": {
        "facts": {
          "body": "What are the facts, and what did each party argue?";
          "name": "Facts and positions";
        };
        "holding": {
          "body": "What did the court decide, and why?";
          "name": "Holding and reasons";
        };
        "precedent": {
          "body": "Which earlier decisions does it rely on, and does it follow them?";
          "name": "Earlier decisions";
        };
        "provisions": {
          "body": "Which provisions does the court apply, and how does it read them?";
          "name": "Provisions applied";
        };
      };
    };
    "citation": {
  ...
  "fileDetail": {
    ...
    "compareChangeKinds": {
      ...
      "tableDelete": "Deleted tables";
      "tableInsert": "Inserted tables";
      "tableRowDelete": "Deleted table rows";
      "tableRowInsert": "Inserted table rows";
    };
    "compareChangeSummary": "Changes by type";
    "compareCreated": "Tracked-changes document created";
    "compareFailed": "Comparison failed";
    "compareNeedsTwoVersions": "Upload another DOCX version to compare.";
    "compareNoChanges": "No supported differences were found.";
    "comparePreviewDescription": "Review the change summary. Saving adds a derived comparison to version history without changing the current version.";
    "comparePreviewReady": "Comparison ready";
    "compareRedlineOpened": "The saved comparison is open in the document viewer.";
    "compareRedlineUnavailable": "The comparison was saved, but its file could not be opened. Refresh the version history to try again.";
    "compareRequestFailed": "The versions could not be compared.";
    "compareTo": "Compare to";
    "compareUnsupported": "{count, plural, one {# part not compared} other {# parts not compared}}";
    "compareUnsupportedDescription": "These document parts were not compared:";
    "compareUnsupportedReasons": {
    ...
    "compareVerified": "Verified comparison";
    "compareVersions": "{targetVersion} vs {baseVersion}";
    "compareVersionsDescription": "Select the earlier version as the base and the later version as the target.";
    "compareVersionsTitle": "Compare document versions";
    ...
    "savingComparison": "Saving comparison…";
  ...
  "guides": {
    ...
    "nudge": {
      "action": "Open guides";
      "body": "New here? A few short tours show you around.";
    };
    "status": {
      "skipped": "Skipped";
    };
    "tours": {
      "chat": {
        "description": "Add context for AI and send your request securely";
        "examplePrompt": "Summarize the key obligations in this contract";
        "steps": {
          "anonymize": {
            "body": "Hides personal data before sending, then restores it in the answer.";
          ...
          "context": {
            "body": "Adds an existing matter or file as context. Nothing is uploaded or copied.";
          ...
          "plusMenu": {
            "body": "Use + to attach a file or reference a matter.";
            "title": "Add context with +";
            "when": "When the context you need is not yet in the chat.";
          };
          "send": {
            ...
            "title": "Send it";
            "when": "The first answer shows what is still missing.";
          };
        };
        "title": "Start with chat";
      };
      "chatPower": {
        "description": "Use skills or connect other useful tools";
        "steps": {
          "mcp": {
          ...
          "plusMenu": {
            "body": "The same menu also holds the model switch, skills, and connected tool servers. The next steps open it and take each in turn.";
            "title": "More behind the + button";
          };
          "skills": {
      ...
      "playbooks": {
        "description": "Save a document review process for next time";
        "steps": {
          "basics": {
            "body": "Add a name and description. Limit it to a document type if needed.";
            "title": "Name the playbook";
          };
          "create": {
            "body": "Start with a blank playbook.";
            "title": "Create a playbook";
          };
          "overview": {
            "body": "A playbook keeps questions and rules for other documents.";
            "title": "Save the review process";
          };
          "positions": {
            "body": "For each rule, choose whether to assess the text or extract a detail.";
  ...
  "inspector": {
    "anonymization": {
      ...
      "unsupportedVisualContent": "This file contains images or vector graphics that cannot be checked for sensitive text. Export is unavailable.";
    ...
    "review": {
      ...
      "summary": {
        ...
        "unnamedReferences": "{count, plural, one {# reference document} other {# reference documents}}";
      };
  ...
  "onboarding": {
    ...
    "cliDocsLink": "Prefer the terminal? Set up the stella CLI";
    "continue": "Continue";
  ...
  "statutes": {
    ...
    "compareAbsent": "Not in this version";
    "compareAddedLater": "This provision did not exist in this version yet.";
    "compareClose": "Close comparison";
    "compareMoved": "Moved:";
    "compareMovedFrom": "Moved here from {provision}";
    "compareMovedFromElsewhere": "Moved here from elsewhere";
    "compareMovedTo": "Moved to {provision}";
    "compareMovedToElsewhere": "Moved elsewhere";
    "compareNoChanges": "The wording is the same in both versions.";
    "compareNoLongerPresent": "This provision is no longer in this version. It was repealed or renumbered.";
    "compareProvisionNeither": "Neither version contains this provision.";
    "compareProvisionTitle": "Changes to {provision} between versions";
    "compareSameVersion": "This is the version on screen. Pick another one to compare with.";
    "compareShowUnchanged": "Show unchanged provisions";
    "compareSideBySide": "Compare side by side";
    "compareTitle": "Changes between versions";
    "compareUnavailable": "The comparison could not be prepared.";
    "compareUnstructured": "One of these versions is available only as plain text, so the two cannot be compared.";
  ...
  "workspaces": {
    ...
    "files": {
      ...
      "pdfSigning": {
        ...
        "cancelledRevokedDescription": "The selected certificate, or one that issued it, has been revoked. Choose a valid certificate.";
        "cancelledSignatureDescription": "The signature from stella desktop did not match the selected certificate. Try signing again.";
        "cancelledStampNameDescription": "The certificate holder's name can't be shown in a visible stamp. Sign again with an invisible signature.";
        "cancelledStampOverflowDescription": "The stamp's text doesn't fit the box you drew. Draw a larger stamp, shorten the reason or location, or use an invisible signature.";
        "cancelledTitle": "Signing cancelled";
        "cancelledUserDescription": "Signing was cancelled in stella desktop.";
        "cancelledWouldBreakSignaturesDescription": "Signing this PDF would invalidate the signatures it already carries.";
        ...
        "placementHint": "Drag the stamp to move it, or drag its corner to resize it. With the stamp selected, arrow keys move it and Shift with an arrow key resizes it.";
        "placementInvisible": "Invisible signature";
        "placementInvisibleDescription": "The signature is stored in the file without a mark on any page.";
        "placementPageLabel": "Stamp page";
        "placementPageOption": "Page {page, number} of {count, number}";
        "placementPreview": "Preview of page {page, number}";
        "placementPreviewFailed": "The page preview could not be loaded.";
        "placementTitle": "Sign PDF";
