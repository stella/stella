...
type Messages = {
  ...
  "chat": {
    ...
    "forkedFrom": "Forked from <bdi>{title}</bdi>";
    "forkedFromUnavailable": "Forked from a conversation that is no longer available";
    "forkingThread": "Forking the conversation…";
