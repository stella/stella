  ...
  "settings": {
    ...
    "organization": {
      ...
      "sso": {
        ...
        "createFailed": "Couldn't create SSO connection";
        "created": "SSO connection created";
        "deleteConfirmation": "Type {domain} to confirm";
        "deleteDescription": "Members will no longer be able to sign in with this connection.";
        "deleteTitle": "Delete SSO connection";
        "deleted": "SSO connection deleted";
        "description": "Connect your identity provider to let members sign in securely.";
        "dnsDescription": "Add this DNS record to verify that you control the domain.";
        "dnsName": "DNS name";
        "dnsValue": "DNS value";
        "domain": "Domain";
        "domainDescription": "Members with this email domain can use this connection to sign in.";
        "domainPending": "Domain verification pending";
        "domainVerified": "Domain verified";
        "enforcement": "SSO enforcement";
        "enforcementUpdated": "SSO enforcement updated";
        "makeOptional": "Make SSO optional";
        "metadataUrl": "Metadata URL";
        "oidcIssuer": "OIDC issuer URL";
        "optional": "Optional";
        "protocol": "Protocol";
        "requestDnsRecord": "Request DNS record";
        "requireDescription": "Require members to sign in through this SSO connection.";
        "requireSso": "Require SSO";
        "samlCertificate": "SAML certificate";
        "samlEntityId": "SAML entity ID";
        "samlSignInUrl": "SAML sign-in URL";
        "title": "Single sign-on";
        "updateFailed": "Couldn't update SSO connection";
