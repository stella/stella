...
type Messages = {
  ...
  "inspector": {
    ...
    "groups": {
      ...
      "fileMoveDescription": "<bdi>{fileName}</bdi> belongs to <bdi>{sourceMatterName}</bdi>. Copy it into <bdi>{matterName}</bdi>, or keep the existing file as a reference.";
      "fileMoveTitle": "Copy this file into the matter?";
      "groupOnly": "Group only";
      "keepReference": "Keep as reference";
