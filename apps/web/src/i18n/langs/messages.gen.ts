...
type Messages = {
  ...
  "docxReview": {
    ...
    "summary": {
      ...
      "formatParagraph": "{label, select, none {Reformat a paragraph} other {Reformat paragraph {label}}}";
      ...
      "mergeParagraphs": "{label, select, none {Merge a paragraph with the next one} other {Merge paragraph {label} with the next one}}";
      ...
      "splitParagraph": "{label, select, none {Split a paragraph} other {Split paragraph {label}}}";
  ...
  "inspector": {
    ...
    "groups": {
      ...
      "chatMoveDescription": "<bdi>{chatName}</bdi> will be grouped under <bdi>{matterName}</bdi>. Add the matter to the chat’s context so it can use its files and information.";
      "chatMoveTitle": "Add this matter to the chat?";
      "collapse": "Collapse {groupName}";
      "color": "Group color";
      "colorOption": "Color {number}";
      "copyIntoMatter": "Copy into matter";
      "expand": "Expand {groupName}";
      "fileMoveDescription": "<bdi>{fileName}</bdi> belongs to <bdi>{sourceMatterName}</bdi>. Copy it into <bdi>{matterName}</bdi>, or group its existing tab there without copying the file.";
      "fileMoveTitle": "Copy this file into the matter?";
      ...
      "remove": "Ungroup tabs";
      "rename": "Rename group";
      "saveFailed": "Could not save tab groups on this browser.";
      "tabCount": "{count, plural, one {# tab} other {# tabs}}";
  ...
  "settings": {
    "account": {
      ...
      "desktopConnectedAs": "Connected as <bdi>{email}</bdi>";
  ...
  "sharing": {
    "access": {
      "accountSwitchHint": "Enter the invited address below and we’ll switch to the right secure session after verification.";
      "checkInbox": "Check your inbox";
      "codeResent": "A fresh code is on its way.";
      "differentEmail": "Use a different email";
      "email": "Email address";
      "emailHint": "If this address is authorized, a six-digit code was sent to {email}.";
      "emailPlaceholder": "you@company.com";
      "emailPrivacy": "We’ll only use this address to verify access to this document.";
      "eyebrow": "Shared with stella";
      "footer": "Protected by recipient verification and short-lived document access";
      "heroDescription": "The sender chose exactly what you can see. Verify your email to open a frozen, private copy—without joining their workspace.";
      "heroTitle": "A document was shared with you, privately.";
      "open": "Open document";
      "otp": "One-time code";
      "privateLink": "Private invitation";
      "resendCode": "Send a new code";
      "secureDocument": "Open your secure document";
      "sendCode": "Send one-time code";
      "sendFailed": "We couldn’t send a code. Please try again.";
      "signedInAs": "You’re currently signed in as {email}";
      "trustIdentity": "Only the invited recipient";
      "trustIdentityDescription": "A one-time code confirms that the invitation reached the right inbox.";
      "trustPrivacy": "Private by design";
      "trustPrivacyDescription": "The invitation disappears from the address bar after verification.";
      "trustSnapshot": "One exact document version";
      "trustSnapshotDescription": "You’ll see the version the sender published—not later workspace changes.";
      "verifyDescription": "Enter the email address this invitation was sent to. No stella workspace account is required.";
      "verifyFailed": "That code or invitation could not be verified.";
    };
    "dialog": {
      "accessLabel": "Access";
      "allowDownload": "Allow original download";
      "cancel": "Cancel";
      "chooseAccess": "Choose the access experience";
      "copied": "Copied";
      "copyAndClose": "Copy & close";
      "copyFailed": "Could not copy the link. Select it manually and try again.";
      "copyHint": "Copy this link now. Stella stores only its cryptographic hash and cannot show it again.";
      "copyLink": "Copy link";
      "description": "Publish an immutable snapshot of {name}. Only the named email can open it with a one-time code.";
      "done": "I’ve saved the link";
      "downloadHint": "Keep this off for view-only access. Downloads use a separate one-minute link.";
      "exactSnapshot": "Exact snapshot";
      "expirationLabel": "Expiration";
      "expiresAt": "Expires (optional)";
      "expiresHint": "Leave blank to keep the share active until you revoke it.";
      "eyebrow": "Secure external sharing";
      "invitationLink": "Private invitation link";
      "linkCreated": "Your private link is ready";
      "loadFailed": "Could not load the current document version.";
      "manage": "Manage shares";
      "promiseAudit": "Every open is audited";
      "promiseOtp": "Email verification required";
      "promiseSnapshot": "Later edits stay private";
      "publish": "Create secure link";
      "publishFailed": "Could not publish this secure share.";
      "publishing": "Stella is preparing the frozen preview in the background. You can send the link now.";
      "readyDescription": "Only {email} can use this invitation. Send it through your usual trusted channel.";
      "readyTitle": "Ready to share";
      "recipientEmail": "Recipient email";
      "recipientHint": "The code will only be sent when this address matches the invitation.";
      "recipientLabel": "Recipient";
      "recipientPlaceholder": "recipient@company.com";
      "revoke": "Revoke instead";
      "revokeFailed": "Could not revoke this share.";
      "revokedToast": "Secure share revoked.";
      "securityReady": "The recipient gets a clean document viewer with no matter navigation, search, or internal chat.";
      "stepConfigure": "Configure access";
      "stepReady": "Link ready";
      "title": "Share a private document link";
      "untilRevoked": "Until revoked";
      "version": "Version {version}";
      "viewAndDownload": "View + download";
      "whoCanOpen": "Who can open this?";
    };
    "manage": {
      "activeShares": "Active shares";
      "cancel": "Keep active";
      "description": "A calm control center for every immutable document you’ve shared outside this matter.";
      "documentCount": "{count, plural, one {# document} other {# documents}}";
      "downloadAllowed": "Download allowed";
      "empty": "Your secure sharing space is ready";
      "emptyHint": "Open any document’s menu and choose Share securely. Stella will freeze the exact version and guide you through recipient access.";
      "emptyOtp": "Email-verified access";
      "emptySnapshots": "Immutable snapshots";
      "expires": "Expires {date}";
      "eyebrow": "External access";
      "loadFailed": "Could not load secure shares.";
      "loading": "Loading secure shares…";
      "noExpiration": "No expiration";
      "peopleWithAccess": "Named recipients";
      "preparingHint": "Creating a private viewing copy. This page updates automatically.";
      "preparingShares": "Preparing";
      "recentShares": "Shared documents";
      "recentSharesHint": "Review access at a glance and revoke it instantly when the work is done.";
      "recipientCount": "{count, plural, one {# recipient} other {# recipients}}";
      "refreshing": "Updating";
      "revoke": "Revoke";
      "revokeConfirm": "Revoke access";
      "revokeDescription": "The recipient will immediately lose access to {name}. Existing short-lived preview links may take a few minutes to expire.";
      "revokeFailed": "Could not revoke this share.";
      "revokeTitle": "Revoke this private link?";
      "revokedOn": "Revoked {date}";
      "revokedToast": "Secure share revoked.";
      "securityNote": "Workspace content stays private";
      "status": {
        "active": "Active";
      ...
      "summary": "{status} · {recipientCount, plural, one {# recipient} other {# recipients}} · {itemCount, plural, one {# document} other {# documents}}";
      "title": "Secure shares";
      "tryAgain": "Try again";
    };
    "viewer": {
      ...
      "downloadAllowed": "Download allowed";
      "downloadFailed": "Could not download this document.";
      "expires": "Access expires {date}";
      "loading": "Loading secure document…";
      "preparing": "Preparing your private preview";
      "preparingHint": "This usually takes only a moment.";
      "previewUnavailable": "The document preview is currently unavailable.";
      "previewUnavailableHint": "The private preview link may have timed out. Request a fresh one to continue.";
      "privateSession": "Private recipient session";
      "published": "Published";
      "publishedSnapshot": "Published snapshot";
      "securelyShared": "Shared securely with you";
      "tryAgain": "Try again";
      "unavailable": "This share is not available";
      "unavailableDescription": "The sender may have revoked access, the invitation may have expired, or this account may not be the invited recipient.";
  ...
  "templates": {
    ...
    "directiveElif": "Else if: {expression}";
    "directiveElse": "Else";
    "directiveEndFor": "End loop";
