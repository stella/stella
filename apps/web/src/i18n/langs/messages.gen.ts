...
type Messages = {
  ...
  "contacts": {
    ...
    "importStudio": {
      ...
      "fileInvalid": "Choose one CSV or TSV file.";
      ...
      "importSuccess": "{count, plural, one {# contact imported} other {# contacts imported}}.";
      ...
      "ready": "Ready";
      "reviewDescription": "Nothing has been imported yet. Fix the source file or mapping if a row has an error.";
      ...
      "stepMap": "Map fields";
      "stepUpload": "Upload";
      "supportedFiles": "CSV and TSV, up to 500 contacts";
