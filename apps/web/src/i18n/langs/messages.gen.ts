...
type Messages = {
  ...
  "inspector": {
    ...
    "groups": {
      ...
      "chatMoveDescription": "{chatName} will be grouped under {matterName}. Add the matter to the chat’s context so it can use its files and information.";
      ...
      "fileMoveDescription": "{fileName} belongs to {sourceMatterName}. Copy it into {matterName}, or keep the existing file as a reference.";
