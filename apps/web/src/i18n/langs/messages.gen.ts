...
type Messages = {
  ...
  "guides": {
    ...
    "tours": {
      "chat": {
        "description": "Write a prompt and get an answer";
        "examplePrompt": "Summarize the key obligations in this contract";
        "steps": {
          "composer": {
            "body": "Type your question or instruction in the message box.";
            "title": "Write your request";
          };
          "send": {
            "body": "Send your message and the workspace responds.";
            "title": "Send it";
          };
          "tools": {
            "body": "Open the tools menu to attach files, skills, and sources.";
            "title": "Add context";
          };
        };
