...
type Messages = {
  ...
  "contacts": {
    ...
    "import": {
      ...
      "dialogDescription": "Upload a .txt file with one client per block (blank line separated) to create multiple contacts at once.";
      "dialogTitle": "Import contacts";
      "errors": {
        "duplicateTaxIdInFile": "Duplicate tax ID in this file (first seen in row {line})";
        "invalidEmailFormat": "Invalid email address";
        "invalidTaxIdLength": "Invalid tax ID (must be 11 or 14 digits)";
        "recommendedMissing": "Recommended field is empty";
        "unrecognizedLabel": "Unrecognized label: {label}";
      };
      "fields": {
