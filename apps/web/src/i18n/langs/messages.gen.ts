...
type Messages = {
  ...
  "guides": {
    ...
    "tours": {
      "chat": {
        "description": "Write a request, add the right file or matter, and send it safely";
        ...
        "steps": {
          ...
          "plusMenu": {
            "body": "The + button opens the composer menu. The next steps open it and show the two options you will use most: attaching a file and referencing a matter.";
      ...
      "chatPower": {
        "description": "Switch models, run skills, and connect tool servers";
        "steps": {
          "mcp": {
