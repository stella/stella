...
type Messages = {
  ...
  "notifications": {
    ...
    "kind": {
      "announcement": "{title}";
      "flowRunAwaitingApproval": "Workflow {flowName} is waiting for your approval";
      "flowRunCompleted": "Workflow {flowName} finished";
      "flowRunFailed": "Workflow {flowName} failed";
