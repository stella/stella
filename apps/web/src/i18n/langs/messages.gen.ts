...
type Messages = {
  ...
  "contacts": {
    ...
    "deleteContactBlockedByMatters": "This contact is still assigned as a client on active matters. Reassign or delete those matters before deleting the contact.";
