...
type Messages = {
  ...
  "guides": {
    ...
    "community": {
      "body": "Stella has a public community chat server. Maintainers and other users answer questions there, share how they work, and pick up bug reports. It is a community forum rather than a support desk: the answer comes from whoever is around.";
