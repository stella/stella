...
export const WorkspaceGridHead = ({
  ...
  <div
    className={cn(
      "group/table-head bg-background text-foreground hover:bg-background after:bg-border/50 border-border/50 relative z-0 grid items-center overflow-visible border-e px-0 text-start font-semibold whitespace-nowrap transition-colors after:pointer-events-none after:absolute after:inset-x-0 after:-bottom-px after:z-20 after:h-px",
      TOOLBAR_ROW_HEIGHT,
      className,
    )}
