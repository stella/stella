 ...
 *
 * The arithmetic itself now lives in `@stll/workspace-inspector`, which
 * takes the sidebar's inline size as a parameter rather than importing it.
 * This module supplies Stella's sidebar sizing so call sites keep the same
 * one-argument shape they had before the extraction.
 */

import { shouldForceSidebarCollapsed as shouldForceSidebarCollapsedWithSidebar } from "@stll/workspace-inspector";
