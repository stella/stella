...
const TemplateStudioChatInner = ({
  ...
  // oxlint-disable-next-line react/refs -- mount-time seed of readiness from the imperative Folio editor instance; the ref read runs once in the useState initializer, and the poll below keeps it in sync
