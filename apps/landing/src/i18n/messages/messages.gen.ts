...
type Messages = {
  ...
  "story": {
    ...
    "dataBody": "Case law and company registries, loaded straight into the matter in every jurisdiction you work in. Anonymization keeps identifying details away from the AI.";
    ...
    "intro": "Source material, review, and finalized documents stay in the matter and build on each other. You can work on the matter together with the AI, and every step it takes can be verified.";
